...
\begin{abstract}
\begin{quote}
\note{PENDING}{Write last, once test numbers exist. Draft thesis: predicting
raw view counts is largely a channel-size readout, so we define the target as a
within-peer-group rank and show what content features add above that floor.}
\end{quote}
\end{abstract}
...
\note{PENDING}{Two threads to write, sources already in 01\_Research/.}
...
\textbf{Multimodal video representation.} \cite{abu2016youtube} establish
...
+ visual & 32 & 0.598 \tiny{$\pm$ 0.051} & 0.585 \tiny{$\pm$ 0.019} \\
+ audio & 124 & 0.587 \tiny{$\pm$ 0.042} & 0.609 \tiny{$\pm$ 0.019} \\
Visual only & 15 & 0.519 \tiny{$\pm$ 0.021} & 0.504 \tiny{$\pm$ 0.015} \\
