...
for 99.0\% of videos, and 96.3\% of Shorts thumbnails are a blurred pillarbox.
Thumbnail brightness, the strongest visual separator in our engineered set, is
therefore a format detector rather than a content feature. Stratifying the label
prevents this from inflating a score, but we report a format-only baseline
alongside every visual result.
...
linear light, and rejects colours further than $\mathrm{Duv}=0.05$ from the
Planckian locus --- because McCamy returns a number for any chromaticity, and
without that gate pure green reports 6069\,K. All 39{,}060 images were
recomputed; the corrected distribution spans 2{,}520--17{,}757\,K with a median
of 5{,}671\,K.
\note{CONFIRMED}{02\_Data/tests/test\_cct.py; D65 white = 6503.5\,K vs 6504 reference}
...
+ visual & 32 & 0.603 \tiny{$\pm$ 0.054} & 0.584 \tiny{$\pm$ 0.028} \\
+ audio & 124 & 0.591 \tiny{$\pm$ 0.041} & 0.609 \tiny{$\pm$ 0.022} \\
Visual only & 15 & 0.526 \tiny{$\pm$ 0.025} & 0.504 \tiny{$\pm$ 0.010} \\
