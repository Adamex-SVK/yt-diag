...
- **stratifier** — used to define label-v2 ranking cells; may also be a model input (safe because every cell has the same ~25% viral rate, so these carry no marginal label information)
